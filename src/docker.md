...
![Alt text](screen/1.png  "загружаем образ Nginx из реестра Docker и проверяем его образ")
...
![Alt text](screen/2.png  "Запускаем образ докера и выводим информацию о контейнере, чтобы узнать, запущен ли он")
...
![Alt text](screen/3.png  "Смотрим информацию о контейнере")
...
![Alt text](screen/4.png  "Останавливаем образ контейнера и выводим информацию о запущенных контейнерах")
...
![Alt text](screen/5.png  "Запускаем докер с портами и проверяем доступ в браузере")
...
![Alt text](screen/6.png  "Перезагружаем контейнер докеров и после проверяем, запущен ли он")
...
![Alt text](screen/7.png  "Смотрим фаил конфигурации nginx.conf")
...
![Alt text](screen/8.png  "Создаем папку на локальном компьютере и переносим туда фаил nginx.conf из докера")
...
![Alt text](screen/9.png  "Настравиваем пути в файле nginx.conf")
...
![Alt text](screen/10.png  "Копируем изменненый фаил из локального компьютера в докер и перезапустите nginx внутри образа докера")
...
![Alt text](screen/11.png  "Смотрим возвращаемую странцу")
...
![Alt text](screen/12.png  "Просматриваем информацию об удаленном контейнере и импортируем его")
...
![Alt text](screen/13.png  "Запускаем импортированный контейнер и просматриваем возвращаемую страницу")
...
![Alt text](screen/15.png  "Пишем мини-сервер на C и запускаем его")
...
![Alt text](screen/16.png  "Читаем созданный на контейнере скрипт для запуска")

3. Напишите свой собственный nginx.conf , который будет проксировать все запросы с порта 81 на 127.0.0.1:8080.:

![Alt text](screen/17.png  "Отправляем наш собственный nginx.conf в докер и читаем его")
...
![Alt text](screen/18.png  "Просматриваем возвращаемую страницу")
...
![Alt text](screen/20.png  "Читаем написанные скрипты")
...
![Alt text](screen/21.png  "Смотрим вывод скрипта RunContanier.sh")
...
![Alt text](screen/22.png  "Проверяем список всех доступных Docker образов")
...
![Alt text](screen/23.png  "Вывод результата скрипта после перезапуска")
...
![Alt text](screen/25.png  "Исправленный Dockerfile")
...
![Alt text](screen/26.png  "Вывод команды после измененения Dockerfile")
...
![Alt text](screen/30.png  "Dockerfile")
...
![Alt text](screen/28.png  "docker-compose.yml")
...
![Alt text](screen/29.png  "docker-compose.yml")
...
![Alt text](screen/31.png  "nginx.conf")
...
![Alt text](screen/27.png  "Вывод страницы")
